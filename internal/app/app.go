...
import (
	...
	"github.com/kevinmichaelchen/api-search/internal/service"
	_ "github.com/lib/pq"
...
func NewSearchClient() *meilisearch.Client {
...
func NewService(p ServiceParams) *service.Service {
	return service.NewService(p.Logger, p.SearchClient)
}
...
func Register(server *grpc.Server, svc *service.Service) {
	v1beta1.RegisterSearchServiceServer(server, svc)
